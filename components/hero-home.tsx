...
export function HeroHome() {
  return (
    <section className="relative min-h-[78vh] overflow-hidden bg-navy text-white md:min-h-[88vh]">
      ...
      />
      {/* Dual overlay: left navy wash for copy legibility + subtle bottom fade */}
      <div
        aria-hidden
        className="absolute inset-0 bg-[linear-gradient(105deg,rgba(11,31,58,0.94)_0%,rgba(11,31,58,0.88)_38%,rgba(11,31,58,0.55)_68%,rgba(13,148,136,0.28)_100%)]"
      />
      <div
        aria-hidden
      ...
      <div className="relative mx-auto flex min-h-[78vh] max-w-6xl flex-col justify-end px-6 pb-20 pt-16 md:min-h-[88vh] md:justify-center md:px-8 md:pb-28 md:pt-24">
        <FadeIn>
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.16em] text-emerald-soft drop-shadow-sm">
            50-Point Proven Plan
          </p>
          <h1 className="font-[family-name:var(--font-syne)] text-4xl font-bold tracking-tight drop-shadow-sm md:text-6xl">
            {siteConfig.name}
          </h1>
          <p className="mt-6 max-w-2xl font-[family-name:var(--font-syne)] text-2xl font-semibold leading-snug text-white drop-shadow-sm md:text-3xl">
